...
public class EfficiencyLastRuns extends SherlockActivity implements OnClickListener {
    ...
    public void init() {
        ...
        lvLastRuns.setAdapter(new ArrayAdapter<Spanned>(getApplicationContext(),
                R.layout.lv_item, runsSpanned));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        ab.setTitle(R.string.prevrunseffi);
